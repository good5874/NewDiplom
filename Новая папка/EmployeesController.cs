...
namespace NewDiplom.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewData["Filter"] = new Diplom.Models.EmployeeFilter.Filter();
            return View(await _context.Employees.ToListAsync());
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Index([Bind("FilterSurname,FilterName,FilterSecond_Name")] Diplom.Models.EmployeeFilter.Filter filter)
        {
